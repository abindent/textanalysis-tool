...
exports.Analyser = exports.Operations = exports.ToolsConstant = void 0;
const esrever_1 = __importDefault(require("esrever"));
require("intl-segmenter-polyfill");
...
exports.ToolsConstant = ToolsConstant;
ToolsConstant.regex = {
    alphabets: /[a-zA-Z]/g,
    numbers: /\d/g,
...
class Analyser {
     ...
     */
    constructor(raw_text, options = {}, languageOptions) {
        this.count = 0;
        this.alphacount = 0;
        this.numericcount = 0;
        this.wordCount = 0;
     ...
     *
     */
    static async create(raw_text, options = {}, langaugeOptions) {
    ...
    async detectLanguage() {
        const detectionResult = this.languageDetector.detect(this.raw_text, this.langaugeOptions);
